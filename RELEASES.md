...
Version 0.10.1 (2025-10-04)
========================
* 新增繁體中文翻譯
* 同步上游分支master
* 裝置：所有視覺警報喚醒裝置（#1309）
* 功能：前車出發提醒（#1302）
* 限速輔助：更新 PCM 縱向的狀態機（#1311）
* sunnylink：預設為啟用（#1312 ）
* sunnylink：增強了參數鍵的資料類型取得（#1308）
* 特斯拉：MADS 全面支援車輛匯流排線束（#1310）
* ui：替換 static_cast<int> 為 std::nearbyint 用於轉換和舍入（#1313）

Version 0.10.1 (2025-10-02)
========================
* 同步上游分支master
* 新增E2E相關顯示

Version 0.10.1 (2025-09-13)
========================
* 同步上游分支(開發者UI)
