...
FOLLOW_PROFILES = {
  LongPersonality.relaxed:    [1.70, 1.70, 1.75, 2.00,  2.00, 2.00, 2.00, 2.00],
  LongPersonality.standard:   [1.40, 1.40, 1.45, 1.75, 1.75, 1.75, 1.75, 1.75],
  LongPersonality.aggressive: [1.05, 1.05, 1.15, 1.45, 1.45, 1.45, 1.45, 1.45],
}

FOLLOW_BREAKPOINTS =          [0.,   3.,    6.,  20.,  30.,  40.,  50.,  60.]
